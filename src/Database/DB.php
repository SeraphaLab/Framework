...
final class DB
{
    ...
    // Read Operations
    public function read(string $query, ?string $bindTypes = null, ?array $conditions = null)
    {
    ...
    // Read multiple rows
    public function readAll(string $query, ?string $bindTypes = null, ?array $conditions = null)
    {
        $dataRead = new DataRead($this->dbConnection);
    ...
    // Count rows
    public function count(string $query, ?string $bindTypes = null, ?array $conditions = null)
    {
        $dataRead = new DataRead($this->dbConnection);
